...
def criar_tipo_dispositivo(novo_tipo: TipoDispositivoCreate):
...
def listar_tipo_dispositivo(tipo_id: int):
...
def atualizar_tipo_dispositivo(tipo_id: int, novo_tipo: TipoDispositivoUpdate):
    tipo = TipoDispositivoDB.get_or_none(TipoDispositivoDB.id == tipo_id)
...
def excluir_tipo_dispositivo(tipo_id: int):
    tipo = TipoDispositivoDB.get_or_none(TipoDispositivoDB.id == tipo_id)
