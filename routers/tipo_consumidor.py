...
def criar_tipo_consumidor(novo_tipo: TipoConsumidorCreate):
...
def excluir_tipo_consumidor(tipo_id: int):
    tipo = TipoConsumidorDB.get_or_none(TipoConsumidorDB.id == tipo_id)
